      ...
      <div class="main-container">
        <div class="profile">
          <div class="profile-avatar">
            <img src={tie} alt="" class="profile-img" />
            <div class="profile-name">Tunde Philps</div>
          </div>
          <img src={port4} alt="" class="profile-cover" />
            ...
            <div class="intro box">
              ...
              <div class="info">
                ...
                <div class="info-item">
                  ...
                  Live in <a href="#">Lagos, Nigeria</a>
                </div>
                <div class="info-item">
                  <svg
                    viewBox="0 0 512 512"
                  ...
                  Player name <a href="#">Tunde Philps</a>
                </div>
              </div>
            </div>
            <div class="event box">
            ...
            <div class="album box">
              <div class="status-main">
                ...
                <div class="album-detail">
                  <div class="album-title" style={{ color: "white" }}>
                    <strong>Lee Kwan Yu</strong> create new <span>album</span>
                  </div>
                  <div class="album-date">6 hours ago</div>
                </div>
                <button class="intro-menu"></button>
              </div>
              <div class="album-content" style={{ color: "white" }}>
